...
class _ObraDetalhesPageState extends State<ObraDetalhesPage> {
  ...
  Future<void> _carregarObra() async {
    ...
    try {
      ...
      // ========================================================
      // REGISTRAR OBRA NO HISTÓRICO DE CONSULTAS
      // ========================================================
      //
      // Este é o ponto que estava faltando.
      //
      // A obra será guardada localmente no Hive e,
      // se houver usuário autenticado, também no Supabase.
      //

      await _historico.registrarConsulta(obra.id);
